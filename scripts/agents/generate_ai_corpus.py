...
PROMPTS = [
    ...
    # Urban / infrastructure (neutral documentary style)
    "An old brick warehouse converted into a modern office space",
    "A quiet cobblestone alley in a European old town at dawn",
    "An overgrown railway track with wildflowers between the sleepers",
    "A wooden footbridge crossing a stream in a park",
    "A row of colourful terraced houses on a steep hill",
    "An empty outdoor market square with metal stalls and awnings",
    "A vintage red telephone box next to a stone wall",

    # Public spaces / civic (neutral, no political content)
    "A public library reading room with tall windows and wooden desks",
    "A community garden with raised beds and a greenhouse",
    "A modern museum atrium with a glass ceiling and spiral staircase",
    "A university lecture hall with tiered seating and a chalkboard",
    "A town hall clock tower against a clear blue sky",

    # Nature / environment (neutral, no disaster imagery)
    "A glacier reflecting in a still alpine lake at sunrise",
    "A dried-up riverbed with cracked mud patterns in warm light",
    "A dense pine forest with morning mist between the trees",
    "A row of wind turbines on rolling green hills",
    "A healthy coral reef with tropical fish in clear blue water",
    "An aerial photograph of farmland showing field patterns from above",
    "A solar panel farm stretching across a desert landscape",
    "A lighthouse on a rocky cliff with waves below",
    "A polar bear walking across tundra with snow-capped mountains behind",
    "A coastal path with wooden fencing along white chalk cliffs",
    ...
    "A magnifying glass resting on a vintage photograph on a wooden desk",

...
<article aria-labelledby="methodology-heading">
  ...
  <section aria-labelledby="trust-score-heading" class="mb-12" id="trust-score">
      ...
      <table class="w-full text-sm border-collapse" aria-label="Trust level thresholds">
        ...
        <tbody class="divide-y divide-border-light dark:divide-border-dark">
          <tr>
            ...
            <td class="py-2.5 pr-6 tabular-nums muted-help">71% – 100%</td>
            <td class="py-2.5 pr-6 text-malachite-dark dark:text-malachite-light font-medium">Authentic</td>
            <td class="py-2.5 muted-help">No detectors flagged anomalies. Content appears consistent with authentic capture.</td>
          </tr>
          <tr>
            <td class="py-2.5 pr-6">
              <span class="inline-flex items-center gap-1.5">
            ...
            <td class="py-2.5 pr-6 tabular-nums muted-help">40% – 70%</td>
            <td class="py-2.5 pr-6 text-amber-dark dark:text-amber-light font-medium">Inconclusive</td>
            <td class="py-2.5 muted-help">Some signals raised concerns but evidence is not definitive. Human review is recommended.</td>
          </tr>
          <tr>
            <td class="py-2.5 pr-6">
              <span class="inline-flex items-center gap-1.5">
            ...
            <td class="py-2.5 pr-6 tabular-nums muted-help">0% – 39%</td>
            <td class="py-2.5 pr-6 text-cinnabar-dark dark:text-cinnabar-light font-medium">Synthetic</td>
            <td class="py-2.5 muted-help">Multiple strong signals indicate manipulation or AI generation.</td>
          </tr>
        </tbody>
      </table>
    </div>
    ...
    <p class="text-xs muted-help mb-6 italic">
    ...
    <div class="overflow-x-auto mb-6">
      <table class="w-full text-sm border-collapse" aria-label="PDF document scoring rules">
        ...
        <tbody class="divide-y divide-border-light dark:divide-border-dark">
          <tr>
            <td class="py-2.5 pr-6 muted-help">Valid C2PA manifest present</td>
            <td class="py-2.5 tabular-nums text-malachite-dark dark:text-malachite-light font-medium">82%</td>
          </tr>
          <tr>
            <td class="py-2.5 pr-6 muted-help">C2PA manifest present but invalid signature</td>
            <td class="py-2.5 tabular-nums text-cinnabar-dark dark:text-cinnabar-light font-medium">25%</td>
          </tr>
          <tr>
            <td class="py-2.5 pr-6 muted-help">No C2PA manifest</td>
      ...
      <table class="w-full text-sm border-collapse" aria-label="Investigation modes comparison">
        ...
        <tbody class="divide-y divide-border-light dark:divide-border-dark">
          <tr>
            ...
            <td class="py-2.5 pr-6 tabular-nums muted-help">~15 s</td>
            <td class="py-2.5 pr-6 muted-help">EXIF anomaly, C2PA, ELA, AI detection</td>
            <td class="py-2.5 muted-help">Routine triage and quick authenticity checks</td>
          </tr>
          <tr>
            <td class="py-2.5 pr-6 font-medium text-text-light dark:text-quartz">Deep</td>
            <td class="py-2.5 pr-6 tabular-nums muted-help">~60 s</td>
            <td class="py-2.5 pr-6 muted-help">All detectors, including regional analysis</td>
            <td class="py-2.5 muted-help">Investigating specific concerns or disputed content</td>
          </tr>
        </tbody>
      </table>
    </div>
  ...
  <section aria-labelledby="detector-reference-heading" class="mb-12" id="detector-reference">
    ...
    <div class="space-y-2">
      ...
      <details class="group rounded border border-border-light dark:border-border-dark bg-white dark:bg-graphite">
        ...
        >
          <span class="flex items-center gap-3">
            <span class="text-xs font-mono tabular-nums muted-help w-5 flex-shrink-0" aria-hidden="true">01</span>
            <span class="font-medium text-sm text-text-light dark:text-quartz">EXIF Anomaly Detection</span>
          </span>
          <span class="flex-shrink-0 text-xs muted-help select-none">
        ...
        <div class="px-4 pb-4 pt-3 border-t border-border-light dark:border-border-dark">
          <dl class="space-y-3 text-sm">
            ...
            <div>
              ...
              <dd class="muted-help">Standard &#183; Deep</dd>
            </div>
            <div>
      ...
      <details class="group rounded border border-border-light dark:border-border-dark bg-white dark:bg-graphite">
        ...
        >
          <span class="flex items-center gap-3">
            <span class="text-xs font-mono tabular-nums muted-help w-5 flex-shrink-0" aria-hidden="true">02</span>
      ...
      <details class="group rounded border border-border-light dark:border-border-dark bg-white dark:bg-graphite">
        ...
        >
          <span class="flex items-center gap-3">
            <span class="text-xs font-mono tabular-nums muted-help w-5 flex-shrink-0" aria-hidden="true">03</span>
      ...
      <details class="group rounded border border-border-light dark:border-border-dark bg-white dark:bg-graphite">
        ...
        >
          <span class="flex items-center gap-3">
            <span class="text-xs font-mono tabular-nums muted-help w-5 flex-shrink-0" aria-hidden="true">04</span>
      ...
      <details class="group rounded border border-border-light dark:border-border-dark bg-white dark:bg-graphite">
        ...
        >
          <span class="flex items-center gap-3">
            <span class="text-xs font-mono tabular-nums muted-help w-5 flex-shrink-0" aria-hidden="true">05</span>
      ...
      <details class="group rounded border border-border-light dark:border-border-dark bg-white dark:bg-graphite">
        ...
        >
          <span class="flex items-center gap-3">
            <span class="text-xs font-mono tabular-nums muted-help w-5 flex-shrink-0" aria-hidden="true">06</span>
      ...
      <details class="group rounded border border-border-light dark:border-border-dark bg-white dark:bg-graphite">
        ...
        >
          <span class="flex items-center gap-3">
            <span class="text-xs font-mono tabular-nums muted-help w-5 flex-shrink-0" aria-hidden="true">07</span>
      ...
      <details class="group rounded border border-border-light dark:border-border-dark bg-white dark:bg-graphite">
        ...
        >
          <span class="flex items-center gap-3">
            <span class="text-xs font-mono tabular-nums muted-help w-5 flex-shrink-0" aria-hidden="true">08</span>
      ...
      <details class="group rounded border border-border-light dark:border-border-dark bg-white dark:bg-graphite">
        ...
        >
          <span class="flex items-center gap-3">
            <span class="text-xs font-mono tabular-nums muted-help w-5 flex-shrink-0" aria-hidden="true">09</span>
      ...
      <details class="group rounded border border-border-light dark:border-border-dark bg-white dark:bg-graphite">
        ...
        >
          <span class="flex items-center gap-3">
            <span class="text-xs font-mono tabular-nums muted-help w-5 flex-shrink-0" aria-hidden="true">10</span>
            <span class="font-medium text-sm text-text-light dark:text-quartz">
              CLIP Detection
              <span class="ml-1.5 text-xs font-normal muted-help">(optional)</span>
            </span>
          </span>
          <span class="flex-shrink-0 text-xs muted-help select-none">
            <span class="hidden group-open:inline">Close</span>
        ...
        <div class="px-4 pb-4 pt-3 border-t border-border-light dark:border-border-dark">
          <dl class="space-y-3 text-sm">
            ...
            <div>
              <dt class="font-medium text-text-light dark:text-quartz mb-0.5">Active in modes</dt>
              <dd class="muted-help">Deep (only when the optional model is installed)</dd>
            </div>
            <div>
              <dt class="font-medium text-text-light dark:text-quartz mb-0.5">Known Limitations</dt>
              <dd class="muted-help leading-relaxed">
      ...
      <details class="group rounded border border-border-light dark:border-border-dark bg-white dark:bg-graphite">
        ...
        >
          <span class="flex items-center gap-3">
            <span class="text-xs font-mono tabular-nums muted-help w-5 flex-shrink-0" aria-hidden="true">12</span>
        ...
        <div class="px-4 pb-4 pt-3 border-t border-border-light dark:border-border-dark">
          <p class="text-xs muted-help leading-relaxed mb-3 italic">
          ...
          <dl class="space-y-3 text-sm">
            ...
            <div>
              <dt class="font-medium text-text-light dark:text-quartz mb-0.5">Active in modes</dt>
              <dd class="muted-help">Standard &#183; Deep (video files only)</dd>
            </div>
            <div>
              <dt class="font-medium text-text-light dark:text-quartz mb-0.5">Known Limitations</dt>
              <dd class="muted-help leading-relaxed">
        ...
        <details class="group rounded border border-border-light dark:border-border-dark bg-white dark:bg-graphite">
          ...
          <div class="px-4 pb-4 pt-3 border-t border-border-light dark:border-border-dark">
            <dl class="space-y-3 text-sm">
              ...
              <div>
                <dt class="font-medium text-text-light dark:text-quartz mb-0.5">Active in modes</dt>
                <dd class="muted-help">On-demand investigation tool (not part of the automatic pipeline)</dd>
              </div>
              <div>
                <dt class="font-medium text-text-light dark:text-quartz mb-0.5">Known Limitations</dt>
                <dd class="muted-help leading-relaxed">
    ...
    <ul class="space-y-5">
      ...
      <li class="flex gap-3 text-sm">
        ...
        <div>
          ...
          <p class="muted-help leading-relaxed">
      ...
      <table class="w-full text-sm border-collapse" aria-label="Detector signal weights">
        ...
        <tbody class="divide-y divide-border-light dark:divide-border-dark">
          <tr>
            ...
            <td class="py-2.5 muted-help">Most reliable single manipulation indicator</td>
          </tr>
          <tr>
            ...
            <td class="py-2.5 muted-help">Regional variant; high specificity for compositing</td>
          </tr>
          <tr>
            <td class="py-2.5 pr-6 text-text-light dark:text-quartz">Colour Temperature</td>
            <td class="py-2.5 pr-6 tabular-nums font-medium text-text-light dark:text-quartz">1.5</td>
            <td class="py-2.5 muted-help">Strong composite indicator when consistent with other regional signals</td>
          </tr>
          <tr>
            ...
            <td class="py-2.5 muted-help">Standard weight; useful for both AI detection and compositing</td>
          </tr>
          <tr>
            <td class="py-2.5 pr-6 text-text-light dark:text-quartz">Copy-Move Detection</td>
            <td class="py-2.5 pr-6 tabular-nums font-medium text-text-light dark:text-quartz">1.0</td>
            <td class="py-2.5 muted-help">Standard weight; specific to clone stamp manipulation</td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td class="py-2.5 pr-6 muted-help italic">Independent</td>
            <td class="py-2.5 muted-help">Considered via worst-case combination with manipulation score; not pooled into the weighted sum</td>
          </tr>
        </tbody>
      </table>
    </div>

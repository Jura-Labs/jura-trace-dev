  ...
  <div class="overflow-x-auto mb-6">
    <table class="w-full text-sm border-collapse">
      ...
      <tbody class="text-flint-dark dark:text-flint-light">
        ...
        <tr class="border-b border-border-light/50 dark:border-border-dark/50">
          <td class="py-2 pr-4 font-semibold text-amber-dark dark:text-amber-light">Moderate</td>
        ...
        <tr>
          <td class="py-2 pr-4 font-semibold text-cinnabar-dark dark:text-cinnabar-light">Low Trust</td>

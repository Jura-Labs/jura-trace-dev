...
<article aria-labelledby="bedrock-heading">
  ...
  <nav aria-label="Page contents" class="mb-10">
    ...
    <ol class="space-y-1 text-sm">
      ...
      <li><a href="#switching-modes" class="text-lapis dark:text-lapis-light hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-lapis rounded">Switching modes</a></li>
      <li><a href="#which-should-i-use" class="text-lapis dark:text-lapis-light hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-lapis rounded">Which mode should I use?</a></li>
    </ol>
  </nav>
  ...
  <section aria-labelledby="obtaining-cert-heading" id="obtaining-cert" class="mb-12">
    ...
    <ol class="list-decimal pl-5 space-y-2 text-sm text-flint dark:text-flint-light leading-relaxed mb-6">

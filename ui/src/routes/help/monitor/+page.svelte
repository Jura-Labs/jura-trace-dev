      ...
      <div class="overflow-x-auto mb-3">
        <table class="w-full text-sm border-collapse">
          ...
          <tbody class="text-flint-dark dark:text-flint-light">
            ...
            <tr>
              <td class="py-2 pr-4 font-semibold text-cinnabar-dark dark:text-cinnabar-light">Synthetic</td>
...
<section id="the-audit-trail" class="mb-12" aria-labelledby="heading-the-audit-trail">
  ...
  <div class="space-y-4 mb-6">
    ...
    <div>
      ...
      <ul class="space-y-1 text-sm text-text-light dark:text-quartz leading-relaxed">
        <li class="flex gap-2">
    ...
    <table class="w-full text-sm border-collapse">
      ...
      <tbody class="text-flint-dark dark:text-flint-light">
        ...
        <tr class="border-b border-border-light/50 dark:border-border-dark/50">
          ...
          <td class="py-2 text-cinnabar-dark dark:text-cinnabar-light">✗ Style alone cannot be fingerprinted</td>
        </tr>
        <tr>

# Jura Trace — Quick Start (Windows)
...
| Video and audio analysis | FFmpeg — see **Settings** for the download link |
| AI-assisted descriptions | Ollama — download from ollama.com |

Full documentation: click **Help** inside the app.

For installation problems, see [`windows-unsigned.md`](./windows-unsigned.md).
